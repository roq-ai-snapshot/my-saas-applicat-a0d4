  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Empower Your Culinary Journey with My SaaS Application: Streamlining Restaurant Management for Exceptional Dining Experiences"
        />
      </Head>
        ...
        <Flex p={8} flex={1} align={'center'} justify={'center'}>
          <Stack position="relative" spacing={6} w={'full'} maxW={'lg'}>
            ...
            <Text fontSize={{ base: 'md', lg: 'lg' }} color={'gray.500'}>
              {`Empower Your Culinary Journey with My SaaS Application: Streamlining Restaurant Management for Exceptional Dining Experiences`}
            </Text>
            <Text>member</Text>
